...
class AddNewEateryPage extends StatefulWidget {
  @override
  _AddNewEateryPageState createState() => _AddNewEateryPageState();
}

class _AddNewEateryPageState extends State<AddNewEateryPage> {
  bool map = false;
    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 15,),
            Text('Select the eatery',style: TextStyle(color: Colors.black,fontSize: 22,fontWeight: FontWeight.bold),),
            SizedBox(
              height: 20,
            ),
            Row(
            ...
            SizedBox(
              ...
              Text('No Listed here?',style: TextStyle(fontSize: 22,color: Colors.black,fontWeight: FontWeight.bold),),
            Row(
              children: <Widget>[
                SizedBox(height:20,),
                ...
                RichText(
                  text: TextSpan(children: <TextSpan>[
                    TextSpan(
                        text: "Add new eatery",
                        style: TextStyle(fontSize: 18, color: Color.fromRGBO(54, 191, 54, 2),fontWeight: FontWeight.bold)),
                  ]),
                )
              ],
            ),
